...
createPickerComponent({
    ...
    lifetimes: {
        attached() {
            this.cascadeData = this.list.slice();
            this.pickerSelectedIndex = this.selectedIndex.slice();
            this.oldIndex = this.selectedIndex.slice();
    ...
    methods: {
        ...
        onColumnChange(e) {
            ...
            if (index === this.pickerSelectedIndex[column])
                return;
            this.oldIndex = this.pickerSelectedIndex.slice();
